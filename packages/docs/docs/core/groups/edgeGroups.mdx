...
| The spaced themes (`themeLightSpaced`, `themeAbyssSpaced`, `themeNordSpaced`, `themeCatppuccinMochaSpaced`, `themeSolarizedLightSpaced`, `themeGithubDarkSpaced`, `themeGithubLightSpaced`), `themeSlate`, `themeSlateDark` | `32`                     |
