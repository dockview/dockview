...
| The spaced themes (`themeLightSpaced`, `themeAbyssSpaced`, `themeNordSpaced`, `themeCatppuccinMochaSpaced`, `themeSolarizedLightSpaced`, `themeGithubDarkSpaced`, `themeGithubLightSpaced`) | `28`                     |
| `themeSlate`, `themeSlateDark`                 | `32`                     |
