...
`DockviewApi` exposes four events specific to popout windows:
...
// Fires when a popout window could not be used, saying which way it failed
api.onDidOpenPopoutWindowFail((failure) => {
