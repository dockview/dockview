...
You are free to evaluate the enterprise features locally without a key, where
Dockview shows a watermark. A licence is required to deploy to production.
...
[Start a free 30-day trial](/trial), confirm your email address and the key is
sent to you. To buy, see [Licensing](/docs/overview/licence) for what the
enterprise features are and
[purchase a licence](https://dockview.dev/enterprise) when you are ready, or
[contact us](/contact) if you would rather be invoiced or have a question first.
